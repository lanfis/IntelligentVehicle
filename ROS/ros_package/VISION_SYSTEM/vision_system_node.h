...
Vision_System::Vision_System(int thread) : it_(n_), it_roi_(n_), spinner(thread), msg_image(new sensor_msgs::Image), msg_image_roi(new sensor_msgs::Image)
{
    nodeName = "Vision_System";
    ...
    //msg_image = new sensor_msgs::Image;
    //msg_image_roi = new sensor_msgs::Image;
...
void Vision_System::image_roi_get()
{
...
void Vision_System::image_roi_publish()
{
...
void Vision_System::image_publish()
{
...
void Vision_System::camera_info_publish()
{
  create_Camera_Info();
  camera_info_pub_.publish(camera_info_);
}

void Vision_System::create_Camera_Info()
{
  cv::Size size;
...
void Vision_System::create_Camera_Info(const cv::Size &size, const cv::Mat &cameraMatrix, const cv::Mat &distortion, const cv::Mat &rotation, const cv::Mat &projection, sensor_msgs::CameraInfo &cameraInfo) const
{
...
void Vision_System::roi_ratio_callBack(const std_msgs::Float32::ConstPtr& msg)
{
    ROS_INFO("ROI ratio is changed to %f !", msg -> data);
    image_roi_ratio = (msg -> data < 1)? msg -> data : 1;
}

void Vision_System::roi_width_offset_callBack(const std_msgs::Int32::ConstPtr& msg)
{
    ROS_INFO("ROI width offset is changed to %d !", msg -> data);
    image_roi_width_offset = msg -> data;
}

void Vision_System::roi_height_offset_callBack(const std_msgs::Int32::ConstPtr& msg)
{
    ROS_INFO("ROI height offset is changed to %d !", msg -> data);
    image_roi_height_offset = msg -> data;
}

void Vision_System::device_id_callBack(const std_msgs::Int32::ConstPtr& msg)
{
    ROS_WARN("Camera ID is changed to %d !", msg -> data);
    camera -> device_id = msg -> data;
}

void Vision_System::resolution_ratio_callBack(const std_msgs::Float32::ConstPtr& msg)
{
    ROS_WARN("Resolution ratio is changed to %f !", msg -> data);
    camera -> resolution_ratio = msg -> data;
}

void Vision_System::activation_callBack(const std_msgs::Bool::ConstPtr& msg)
{
    activation = msg -> data;
    if(activation)
    {
...
void Vision_System::status_publish(string status)
{
    std_msgs::String msg;
...
void Vision_System::pub_topic_get()
{
...
void Vision_System::pub_shutdown()
{
    it_pub_.shutdown();
...
void Vision_System::sub_topic_get()
{   
...
void Vision_System::sub_init()
{
    roi_ratio_sub_ = n_.subscribe(topic_image_roi_ratio_sub.c_str(), queue_size, &Vision_System::roi_ratio_callBack, this);
    roi_width_offset_sub_ = n_.subscribe(topic_image_roi_width_offset_sub.c_str(), queue_size, &Vision_System::roi_width_offset_callBack, this);
    roi_height_offset_sub_ = n_.subscribe(topic_image_roi_height_offset_sub.c_str(), queue_size, &Vision_System::roi_height_offset_callBack, this);
    device_id_sub_ = n_.subscribe(topic_device_id_sub.c_str(), queue_size, &Vision_System::device_id_callBack, this);
    resolution_ratio_sub_ = n_.subscribe(topic_resolution_ratio_sub.c_str(), queue_size, &Vision_System::resolution_ratio_callBack, this);
    activation_sub_ = n_.subscribe(topic_activation_sub.c_str(), queue_size, &Vision_System::activation_callBack, this);
}

void Vision_System::sub_shutdown()
{
